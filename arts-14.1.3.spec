...
BuildRequires: libpcre2-devel libpcre2-devel-static libtool_2.4 libaudiofile-devel glib2-devel libgsl-devel libltdl7-devel libgpiod-devel libvorbis-devel
